...
import fr.m2miage.geocartebck.dao.MonumentRepository;
...
public class MonumentController
{
    ...
    public ResponseEntity<?> getMonument(@PathVariable("id") int id)
    {
        ...
        return new ResponseEntity<Monument>(current, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> createMonument(@RequestBody Monument target, UriComponentsBuilder ucBuilder)
    {
        ...
        headers.setLocation(ucBuilder.path("/api/monument/{id}").buildAndExpand(target.getId()).toUri());
