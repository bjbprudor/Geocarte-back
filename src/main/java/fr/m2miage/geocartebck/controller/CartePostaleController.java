...
public class CartePostaleController
{
    ...
    public ResponseEntity<?> getCartePostale(@PathVariable("id") int id)
    {
        ...
        return new ResponseEntity<CartePostale>(current, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> createCartePostale(@RequestBody CartePostale target, UriComponentsBuilder ucBuilder)
    {
        ...
        headers.setLocation(ucBuilder.path("/api/cp/{id}").buildAndExpand(target.getId()).toUri());
        return new ResponseEntity<String>(headers, HttpStatus.CREATED);
    }

    // ------------------- Update a CartePostale ------------------------------------------------

    @RequestMapping(value = "/cp/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/cp/{id}", method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/cp/", method = RequestMethod.DELETE)
